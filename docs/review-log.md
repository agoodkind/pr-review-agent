...
| 2026-08-19 | `proof/fallback-provider` | Live fallback provider | Live deployment | Pending | 0 | 0 | Scratch head that proves the deployed fallback answers a review while the primary provider has no remaining usage. |
