...
func buildBatchPrompt(batch []preparedThread, index, total int) string {
	var builder strings.Builder
	builder.WriteString("Writing policy: ")
	builder.WriteString(config.WritingPolicy)
	builder.WriteString("\nUntrusted input policy: ")
	builder.WriteString(review.UntrustedInputPolicy)
	builder.WriteString("\n\nReconciliation batch ")
	fmt.Fprintf(&builder, "%d/%d", index, total)
	builder.WriteString(".\n")
	builder.WriteString(promptInputBegin)
	builder.WriteString("\n")
	...
	builder.WriteString("\n")
	builder.WriteString(promptInputEnd)
	return builder.String()
}
