...
var (
	reviewSchemaJSON    = json.RawMessage(`{"type":"object","additionalProperties":false,"properties":{"summary":{"type":"string"},"coverage_complete":{"type":"boolean"},"findings":{"type":"array","items":{"type":"object","additionalProperties":false,"properties":{"path":{"type":"string"},"start_line":{"type":"integer"},"end_line":{"type":"integer"},"title":{"type":"string"},"body":{"type":"string"},"importance":{"type":"integer"}},"required":["path","start_line","end_line","title","body","importance"]}}},"required":["summary","coverage_complete","findings"]}`)
