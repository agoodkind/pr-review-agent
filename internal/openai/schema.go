...
// The review schema asks for findings and whether supplied omission metadata is
// sufficient to judge the rest of the change.
var (
	reviewSchemaJSON    = json.RawMessage(`{"type":"object","additionalProperties":false,"properties":{"omissions_acceptable":{"type":"boolean"},"findings":{"type":"array","items":{"type":"object","additionalProperties":false,"properties":{"path":{"type":"string"},"start_line":{"type":"integer"},"end_line":{"type":"integer"},"title":{"type":"string"},"body":{"type":"string"},"evidence":{"type":"string"},"claim":{"type":"string"},"suggestion":{"type":"string"},"importance":{"type":"integer"}},"required":["path","start_line","end_line","title","body","evidence","claim","suggestion","importance"]}}},"required":["omissions_acceptable","findings"]}`)
